...
display_welcome() {
  ...
  echo -e ""
  echo -e "𝗪𝗛𝗔𝗧𝗦𝗔𝗣𝗣 :"
  echo -e "0856-0075-3349"
  echo -e "𝗬𝗢𝗨𝗧𝗨𝗕𝗘 :"
  echo -e "@FajarHosting2710"
  echo -e "𝗖𝗥𝗘𝗗𝗜𝗧𝗦 :"
  echo -e "@FAJAR SETIAWAN"
  sleep 4
  clear
}
...
check_token() {
  ...
  if [ "$USER_TOKEN" = "sayangALYA" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN}Buy dulu Weh Ke Fajar https://wa.me/6285600753349${NC}"
    exit 1
  fi
  clear
}
...
install_theme() {
  while true; do
    ...
    case "$SELECT_THEME" in
      1)
        THEME_URL=$(echo -e "https://raw.githubusercontent.com/FajarHosting/tokenfajarXAlya/main/C2.zip")
        break
        ;;
      2)
...
# Unduh file tema
wget -O /root/C2.zip https://raw.githubusercontent.com/FajarHosting/tokenfajarXAlya/main/C2.zip
